...
import secrets
from auth.core.utils import hash_password
...
from auth.core.utils import verify_password, create_access_token, set_auth_cookie
from core.settings import settings
from auth.schemas.user import MessageResponse, SignupOut, SigninOut, AuthOut, UserOut
...
class AuthService:
    ...
    async def signup(
        ...
        return MessageResponse(message="Signup berhasil. Silakan verifikasi email Anda.")

    # =======================================================
    # Verifikasi token email
    async def verify_email_token(self, token: str, tasks: BackgroundTasks, response: Response) -> UserOut:
