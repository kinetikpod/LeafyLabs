...
from app.stat.schema import TtestRequest, TtestResponse, AnovaResponse, AnovaRequest
import pandas as pd
...
class StatService:
    ...
    def run_ttest(self, data: TtestRequest) -> TtestResponse:
        if data.paired:
    ...
    def _run_paired_test(self, data: TtestRequest) -> TtestResponse:
    ...
    def _run_unpaired_test(self, data: TtestRequest) -> TtestResponse:
    ...
    def _build_stat_response(self, result, test_type: str) -> TtestResponse:
